...
class PropertySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $categories =  [
            ...
            ['name' => 'Condo', 'content' => '', 'status' => 'publish',],
            ['name' => 'Family House', 'content' => '', 'status' => 'publish',],
            ['name' => 'Modern Villa', 'content' => '', 'status' => 'publish',],
            ['name' => 'Town House', 'content' => '', 'status' => 'publish',]
        ];
