...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'Find house'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('Find house by')}} <a href="{{__('https://www.bookingcore.org')}}" target="_blank">{{__('FindHouse Team')}}</a>
                    </div>
                    <div class="col-md-6">
