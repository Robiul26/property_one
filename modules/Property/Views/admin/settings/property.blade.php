                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <select  name="property_page_search_layout" class="form-control">
                            <option {{setting_item_with_lang('property_page_search_layout',request()->query('lang')) == 1 ? 'selected="selected"' : ''}} value="1">{{__('Right Sidebar')}}</option>
                            <option {{setting_item_with_lang('property_page_search_layout',request()->query('lang')) == 2 ? 'selected="selected"' : ''}} value="2">{{__('Left Sidebar')}}</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
